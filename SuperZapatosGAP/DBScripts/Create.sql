...
/****** Object:  Database [SuperZapatos]    Script Date: 1/30/2017 4:05:46 PM ******/
CREATE DATABASE [SuperZapatos]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'SuperZapatos', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\SuperZapatos.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
